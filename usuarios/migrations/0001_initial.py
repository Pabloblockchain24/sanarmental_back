    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('ADMIN', 'Administrador'), ('PROF', 'Profesional'), ('PAC', 'Paciente')], default='PAC', max_length=5)),
                ...
                ('imagen', models.ImageField(blank=True, null=True, upload_to='usuarios/imgs/')),
